...
function buildInstructions(
  ...
  return [
    ...
    "OUTLOOK BRIEFING: For 'morning briefing', 'catch me up', 'what needs a reply', or 'what should I focus on', call get_outlook_briefing. Speak only the top 2-3 priorities and say the details are on screen. In chat, use sections: Top priorities, Emails needing action, Calendar, Next steps. Keep it high-level; do not include sender email addresses or message bodies unless explicitly requested.",
