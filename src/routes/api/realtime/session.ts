...
function buildInstructions(
  ...
  return [
    ...
    "Realtime voice has no tools. For fast conversational turns, answer directly and briefly from general knowledge. Tool-heavy requests are routed by the app to the main chat brain, so never claim you are searching, emailing, scheduling, or generating a file unless the app has already inserted that result into chat.",
